...
Declarations of a source file are _exported_ into application (global) scope. If you want some definitions to only be visible in the file itself (in _file scope_), place these behind the **#scope_file;** directive, like this inside a `file1.jai`:  
